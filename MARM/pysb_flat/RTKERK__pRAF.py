...
Parameter('ep_RAF_RAF_mod_RASgtp_double_ddG', 1000.0, nonnegative=False)
Parameter('ep_RAF_RAS_mod_pRAF_ddG', 1000.0, nonnegative=False)
Parameter('ep_RAF_RAF_mod_pRAF_ddG', 1000.0, nonnegative=False)
Parameter('bind_RASgtp_RAF_kf', 10.0)
Parameter('bind_RASgtp_RAF_dG', 0.01, nonnegative=False)
Parameter('bind_RASgtp_RAF_phi', 1.0)
Parameter('bind_RAF_RAF_kf', 10.0)
Parameter('bind_RAF_RAF_dG', 0.01, nonnegative=False)
Parameter('bind_RAF_RAF_phi', 1.0)
Parameter('bind_RAFi_RAF_kf', 10.0)
Parameter('bind_RAFi_RAF_dG', 0.01, nonnegative=False)
Parameter('bind_RAFi_RAF_phi', 1.0)
Parameter('bind_PRAFi_RAF_kf', 10.0)
Parameter('bind_PRAFi_RAF_dG', 0.01, nonnegative=False)
Parameter('bind_PRAFi_RAF_phi', 1.0)
Parameter('ep_RAF_RAF_mod_RAFi_single_ddG', 0.001, nonnegative=False)
Parameter('ep_RAF_RAF_mod_RAFi_double_ddG', 1000.0, nonnegative=False)
Parameter('bind_RAF_uMEK_kf', 10.0)
Parameter('bind_RAF_uMEK_dG', 0.01, nonnegative=False)
...
Parameter('bind_MEKi_MEK_dG', 0.01, nonnegative=False)
Parameter('bind_MEKi_MEK_phi', 1.0)
Parameter('ep_pMEK_MEKi_ddG', 100.0, nonnegative=False)
Parameter('bind_MEK_uERK_kf', 10.0)
Parameter('bind_MEK_uERK_dG', 0.01, nonnegative=False)
Parameter('bind_MEK_uERK_phi', 1.0)
Parameter('catalyze_MEKmekiNone_phosphop_ERK_p_kcat', 10.0)
Parameter('bind_DUSP_pERK_kf', 10.0)
Parameter('bind_DUSP_pERK_dG', 0.01, nonnegative=False)
...
Parameter('bind_EGF_EGFR_dG', 0.01, nonnegative=False)
Parameter('bind_EGF_EGFR_phi', 1.0)
Parameter('bind_EGFR_EGFR_kf', 10.0)
Parameter('bind_EGFR_EGFR_dG', 100.0, nonnegative=False)
Parameter('bind_EGFR_EGFR_phi', 1.0)
Parameter('ep_EGFR_EGFR_mod_EGF_single_ddG', 100.0, nonnegative=False)
...
Parameter('bind_pEGFR_GRB2_dG', 100.0, nonnegative=False)
Parameter('bind_pEGFR_GRB2_phi', 1.0)
Parameter('bind_SPRY_GRB2_kf', 10.0)
Parameter('bind_SPRY_GRB2_dG', 0.01, nonnegative=False)
...
Parameter('bind_GRB2_SOS1_dG', 0.01, nonnegative=False)
...
Parameter('ep_SOS1S1134p_GRB2_ddG', 100.0, nonnegative=False)
Parameter('bind_SOS1_RAS_kf', 10.0)
Parameter('bind_SOS1_RAS_dG', 0.01, nonnegative=False)
Parameter('catalyze_SOS1_RAS_gtp_kcat', 0.01)
Parameter('bind_CBL_GRB2_kf', 10.0)
Parameter('bind_CBL_GRB2_dG', 0.01, nonnegative=False)
