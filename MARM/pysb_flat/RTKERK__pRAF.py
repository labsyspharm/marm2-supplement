...
Rule('BRAF_and_BRAF_bind_and_dissociate', BRAF(raf=None, RBD=ANY) + BRAF(raf=None, RBD=ANY) | BRAF(raf=1, RBD=ANY) % BRAF(raf=1, RBD=ANY), bind_RAF_RAF_phi, Ea0_bind_BRAF_BRAF, energy=True)
Rule('BRAF_and_CRAF_bind_and_dissociate', BRAF(raf=None, RBD=ANY) + CRAF(raf=None, RBD=ANY) | BRAF(raf=1, RBD=ANY) % CRAF(raf=1, RBD=ANY), bind_RAF_RAF_phi, Ea0_bind_BRAF_CRAF, energy=True)
Rule('CRAF_and_CRAF_bind_and_dissociate', CRAF(raf=None, RBD=ANY) + CRAF(raf=None, RBD=ANY) | CRAF(raf=1, RBD=ANY) % CRAF(raf=1, RBD=ANY), bind_RAF_RAF_phi, Ea0_bind_CRAF_CRAF, energy=True)
