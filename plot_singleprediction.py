...
from MARM.visualize import (
    IFLABEL, TIMELABEL,
    plot_simdata_grid, plot_simdatadecomp_grid
)
...
df = read_all_analysis_dataframes(sxs, 'singleprediction')
...
for drug in PANRAFI:
    ...
    plot_simdata_grid(
        ...
        figdir=figdir,
        filename=f'prediction_EGFRwt_dr{drug}.pdf',
    )
    ...
    plot_simdatadecomp_grid(
        ...
        figdir=figdir,
        filename=f'prediction_EGFRwt_dr{drug}_decomp.pdf',
    )
...
for drug in ['LY3009120']:
    ...
    plot_simdata_grid(
        ...
        ylimits=YLIM, logx=True, logy=False, group='EGF_0', color='EGF_0',
        figdir=figdir,
        filename=f'prediction_EGFRa_dr{drug}.pdf',
    )
    ...
    plot_simdatadecomp_grid(
        ...
        ylimits=YLIM, logx=True, logy=False,
        figdir=figdir,
        filename=f'prediction_EGFRa_dr{drug}_decomp.pdf',
    )
...
for meki, rafi, rafi_val in zip(
    ...
    plot_simdata_grid(
        ...
        ylimits=YLIM, logx=True, logy=False, group='EGF_0', color='EGF_0',
        figdir=figdir,
        filename=f'prediction_EGFRwt_dr{meki}_{rafi}{rafi_val}.pdf',
    )
    ...
    plot_simdatadecomp_grid(
        ...
        ylimits=YLIM, logx=True, logy=False,
        figdir=figdir,
        filename=f'prediction_EGFRwt_dr{meki}_{rafi}{rafi_val}_decomp.pdf',
    )
...
plot_simdata_grid(
    ...
    ylimits=YLIM, logx=True, logy=False, group='EGF_0', color='EGF_0',
    figdir=figdir,
    filename=f'prediction_EGFRa_dr{meki}_{rafi}{rafi_val}.pdf',
)
...
plot_simdatadecomp_grid(
    ...
    ylimits=YLIM, logx=True, logy=False,
    figdir=figdir,
    filename=f'prediction_EGFRa_dr{meki}_{rafi}{rafi_val}_decomp.pdf',
)
...
plot_simdata_grid(
    ...
    figdir=figdir,
    filename=f'prediction_EGFRwt_tc_dr{meki}_{rafi}{rafi_val}.pdf',
)
